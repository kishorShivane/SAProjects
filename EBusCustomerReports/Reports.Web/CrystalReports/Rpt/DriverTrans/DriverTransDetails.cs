...
namespace Reports.Web.CrystalReports.Rpt.DriverTrans {
    using System;
    ...
    public class DriverTransDetails : ReportClass {
        
        public DriverTransDetails() {
        }
        
        public override string ResourceName {
            get {
                return "DriverTransDetails.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Reports.Web.CrystalReports.Rpt.DriverTrans.DriverTransDetails.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDriverTransDetails : Component, ICachedReport {
        
        public CachedDriverTransDetails() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DriverTransDetails rpt = new DriverTransDetails();
            rpt.Site = this.Site;
            return rpt;
        }
